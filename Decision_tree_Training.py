...
# plots training data using matplotlib library gini is at position 0 , entropy is at position 1
# note: value of min_sample_value is on the x axis, accuracy is on the y axis
plt.scatter(min_sample_value,array_acc_training[0],marker="x")
plt.scatter(min_sample_value,array_acc_training[1],marker="*")
