...
# l1 and l2 were chosen as a prerequisite for liblinear solver
penalty_type = ["l1","l2"]
...
# with these two hyper-parameters note: i and x represents their position in the loop then prints the results out and
# liblinear is being used as the 3rd perimeter
...
plt.scatter(C_type, array_acc_test[0], marker="x")
plt.scatter(C_type, array_acc_test[1], marker="*")
...
plt.title("Effect of C,Liblinear & Penalty Hyper-Perameters on test accuracy", fontsize=10)
plt.show()
